...
export default function Footer() {
  ...
  return (
    <footer
      ...
      className="py-6 px-4 sm:px-6 border-t border-[var(--border)]"
    >
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              <AutoStoriesSharpIcon style={{ color: "var(--foreground)" }} />
              <span className="text-2xl font-bold">Uniplanner</span>
            </div>
            <p className="mb-2" style={{ color: "var(--foreground)" }}>
              Simplifying academic planning for students worldwide.
            </p>
